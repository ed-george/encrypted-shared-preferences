...
/**
 * Based on MasterKeyTest.java from AndroidX Crypto - v1.1.0-alpha07
 *
 * <p>Permalink: <a
...
public class MasterKeyTest {
    ...
    @Test
    public void testCreateKeyWithParamSpecAndAlias() throws GeneralSecurityException, IOException {
        KeyGenParameterSpec spec =
                new KeyGenParameterSpec.Builder(
                                "test_key_alias",
                                KeyProperties.PURPOSE_ENCRYPT | KeyProperties.PURPOSE_DECRYPT)
                        ...
                        .build();
        MasterKey masterKey =
                new MasterKey.Builder(ApplicationProvider.getApplicationContext(), "test_key_alias")
                        .setKeyGenParameterSpec(spec)
                        .build();
        assertKeyExists(masterKey.getKeyAlias());
    }
    ...
    @Test
    public void testCreateKeyWithParamSpecWithDifferentAliasFails()
    ...
    @Test
    public void testCheckIfKeyIsKeyStoreBacked() throws GeneralSecurityException, IOException {
        MasterKey masterKey =
                new MasterKey.Builder(ApplicationProvider.getApplicationContext())
                        .setKeyScheme(MasterKey.KeyScheme.AES256_GCM)
                        .build();
    ...
    @Test
    public void testUseOfSchemeAndParamsFails() throws GeneralSecurityException, IOException {
        KeyGenParameterSpec spec =
                new KeyGenParameterSpec.Builder(
    ...
    @Test
    public void testCheckGettersAreCallable() throws GeneralSecurityException, IOException {
        MasterKey masterKey =
                new MasterKey.Builder(ApplicationProvider.getApplicationContext())
                        .setKeyScheme(MasterKey.KeyScheme.AES256_GCM)
                        .build();
