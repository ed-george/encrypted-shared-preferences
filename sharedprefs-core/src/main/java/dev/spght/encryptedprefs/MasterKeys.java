 ...
 * <hr> Based on MasterKeys.java from AndroidX Crypto - v1.1.0-alpha07
 *
 * <p>Permalink: <a
...
public final class MasterKeys {
    ...
    /**
     * Provides a safe and easy to use KenGenParameterSpec with the settings. Algorithm: AES Block
     * Mode: GCM Padding: No Padding Key Size: 256
     *
     ...
     *
     * <p>The encryption scheme is required fields to ensure that the type of encryption used is
     * clear to developers.
     *
