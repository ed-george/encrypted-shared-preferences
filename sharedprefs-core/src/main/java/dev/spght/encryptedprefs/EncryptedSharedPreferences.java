...
/**
 * An implementation of {@link SharedPreferences} that encrypts keys and values. <br>
 * <br>
 ...
 * <code>EncryptedSharedPreference</code>s from backup using <a
 * href="https://developer.android.com/guide/topics/data/autobackup#IncludingFiles">backup
 * rules</a>. <br>
 * <br>
 ...
 * </pre>
 *
 * <hr> Based on EncryptedSharedPreferences.java from AndroidX Crypto - v1.1.0-alpha07
 *
 * <p>Permalink: <a
 * href="https://android.googlesource.com/platform/frameworks/support/+/e50caacef9794c6c1d05ed647347a01b06b96930/security/security-crypto/src/main/java/androidx/security/crypto/EncryptedSharedPreferences.java">e50caac</a>
 */
public final class EncryptedSharedPreferences implements SharedPreferences {
     ...
     *
     * @deprecated Use {@link #create(Context, String, MasterKey, PrefKeyEncryptionScheme,
     *     PrefValueEncryptionScheme)} instead.
     * @param fileName The name of the file to open; can not contain path separators.
    ...
    public enum PrefKeyEncryptionScheme {
         ...
         *
         * <p><a
         * href="https://google.github.io/tink/javadoc/tink/1.7.0/com/google/crypto/tink/daead/AesSivKeyManager.html">AesSivKeyManager</a>.aes256SivTemplate()
         */
    ...
    public enum PrefValueEncryptionScheme {
         ...
         *
         * <p><a
         * href="https://google.github.io/tink/javadoc/tink/1.7.0/com/google/crypto/tink/aead/AesGcmKeyManager.html">AesGcmKeyManager</a>.aes256GcmTemplate()
         */
    ...
    private static final class Editor implements SharedPreferences.Editor {
        ...
        public @NonNull SharedPreferences.Editor putString(
            ...
            ByteBuffer buffer =
                    ByteBuffer.allocate(Integer.BYTES + Integer.BYTES + stringByteLength);
        ...
        public @NonNull SharedPreferences.Editor putStringSet(
                @Nullable String key, @Nullable Set<String> values) {
            if (values == null) {
                values = new ArraySet<>();
        ...
        @Override
        public @NonNull SharedPreferences.Editor putInt(@Nullable String key, int value) {
        ...
        @Override
        public @NonNull SharedPreferences.Editor putLong(@Nullable String key, long value) {
        ...
        @Override
        public @NonNull SharedPreferences.Editor putFloat(@Nullable String key, float value) {
        ...
        @Override
        public @NonNull SharedPreferences.Editor putBoolean(@Nullable String key, boolean value) {
        ...
        @Override
        public @NonNull SharedPreferences.Editor remove(@Nullable String key) {
        ...
        private void putEncryptedObject(String key, byte[] value) {
            ...
            try {
                Pair<String, String> encryptedPair =
                        mEncryptedSharedPreferences.encryptKeyValuePair(key, value);
    ...
    @Override
    public @Nullable Set<String> getStringSet(
            @Nullable String key, @Nullable Set<String> defValues) {
    ...
    String encryptKey(String key) {
        ...
        try {
            byte[] encryptedKeyBytes =
                    mKeyDeterministicAead.encryptDeterministically(
                            key.getBytes(UTF_8), mFileName.getBytes());
    ...
    String decryptKey(String encryptedKey) {
        try {
            byte[] clearText =
                    mKeyDeterministicAead.decryptDeterministically(
                            Base64.decode(encryptedKey, Base64.DEFAULT), mFileName.getBytes());
